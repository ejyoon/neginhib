...
\begin{figure*}[t!]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/correct_RT_v2.pdf}
...
\begin{figure*}[t!]
\begin{center}
\includegraphics[width=.9\textwidth]{figures/ddm_vis.pdf}
...
As in the standard analyses, we found no significant correlations between individual adults' parameters on the different tasks (all $r$s $< .02$, all $p$s $> .13$
